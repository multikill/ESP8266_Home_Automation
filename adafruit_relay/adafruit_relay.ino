...
#define RELAY 0  // EPS8266 GPIO0
#define BUTTONPRESS 2 // ESP8266 GPIO2
...
#define AIO_USERNAME    "***"
#define AIO_KEY         "***"
#define AIO_FEEDSNAME   "/feeds/onoff"
...
Adafruit_MQTT_Subscribe OnOffbutton = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME AIO_FEEDSNAME);
...
void setup() {
  ...
  WiFi.softAPdisconnect (true); //deactivate AP from ESP
